...
export default function CommitmentSection() {
  ...
  return (
    <div className="text-white py-0 sm:py-12 my-[0px] sm:my-[100px] px-6 md:px-16">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row text-start">
        {/* Left Content */}
        <div
          className="md:w-2/5 space-y-6 order-2 sm:order-1"
          data-aos="fade-right"
          data-aos-delay="500"
        >
          <h2 className="text-[25px] leading-[27px] mt-4 sm:mt-[0px] sm:leading-[46px] md:text-[46px] font-bold text-transparent bg-clip-text font-[Calibri]">
            <span
              style={{
                backgroundImage:
          ...
          <p className="text-[17px] text-white font-medium leading-[25px]">
    ...
    hover:shadow-[0px_7px_29px_0px_gold]"
        ...
        {/* Right Images */}
        <div
          className="md:w-3/5 flex justify-end relative mt-10 md:mt-0 sm:order-2 ordder:1"
          data-aos="fade-left"
          data-aos-delay="500"
        >
